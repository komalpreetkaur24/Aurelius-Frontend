...
const TestimonialsPage = () => {
    ...
    const onTouchEnd = () => {
        ...
        scroller.current && scroller.current.classList.remove("cursor-grabbing");
        startMomentum();
    }; // these all the above functions are for smooth scroll fro x-axis
    return (
        <section className={testimonialPageStyles.pageSection}>
            <div className={testimonialPageStyles.container}>
                ...
                {/* for scrollling on x axis */}
                <div
                    ref={scroller}
                    className={testimonialPageStyles.cardsContainer}
                ...
                >
                    {cards.map((c) => (
                        <article key={c.id} className={testimonialPageStyles.card}>
                            <div className="w-[260px] h-[260px] rounded-xl overflow-hidden shadow-md">
                                <img
                                    src={c.img}
                                    alt={c.title}
