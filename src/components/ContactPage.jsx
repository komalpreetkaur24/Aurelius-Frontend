...
import { AlertCircle, User, Mail, Phone, Clock, ShoppingCart, IndianRupee, MapPin, Send, Check } from "lucide-react";
  ...
  return (
    <div className={contactPageStyles.pageContainer}>
      <div className={contactPageStyles.innerContainer}>
        ...
        {/* fonts */}
        <style>{`
          @import url('https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400;600&family=Playfair+Display:wght@400;600&display=swap');
        `}</style>
      </div>
    </div>
  );
