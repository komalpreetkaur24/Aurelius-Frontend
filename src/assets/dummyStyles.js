...
const testimonialPageStyles = {
  ...
  // Horizontal scroller
  cardsContainer: "flex gap-8 overflow-x-auto pb-6 px-2 md:px-6 snap-x snap-mandatory cursor-grab",

  // Card styles
  card: "snap-center flex-shrink-0 min-w-[92%] md:min-w-[48%] lg:min-w-[49%] bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden flex flex-col lg:flex-row items-center",

  // Image block
 imageBlock: "w-full lg:w-[45%] h-[320px] flex items-center justify-center rounded-l-2xl",

  // Content block
  contentBlock: "w-full lg:w-[60%] p-6 md:p-8",
  cardTitle: "text-lg md:text-xl font-bold tracking-tight text-gray-900 mb-3",
  cardMeta: "text-sm text-gray-400 mb-6",
  cardExcerpt: "text-gray-600 leading-relaxed text-sm md:text-base max-w-md",
...
export const watchPageStyles = {
  ...
  // Watch Card
  card: "group text-center relative",
  imageContainer: "relative mx-auto max-w-[240px] w-full h-[320px] md:h-[420px]",
  image: "w-full h-full object-contain",

  // Cart Controls
  cartControlsContainer: "flex justify-center mt-3 mb-1",
...
export const navbarStyles = {
  ...
  logoText: "text-lg sm:text-2xl md:text-2xl font-semibold tracking-wider",
