...
const CartPage = () => {
    ...
    // maximum digits for mobile number is 10, and only digits allowed
    ...
    // to submit the data and clear the cart
                    ...
                    <div className={cartPageStyles.mainGrid}>
                        <div className={cartPageStyles.leftColumn}>
                            <div className={cartPageStyles.formContainer}>
                                ...
                                <form onSubmit={handleSubmit} className={cartPageStyles.from}>
                                    ...
                                    <div className={cartPageStyles.formButtonContainer}>
                                        <button
                                            type="submit"
